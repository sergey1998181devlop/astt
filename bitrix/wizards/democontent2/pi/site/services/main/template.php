...
CopyDirFiles(
    $_SERVER["DOCUMENT_ROOT"] . '/bitrix/modules/democontent2.pi/install/push',
    WIZARD_SITE_PATH,
    true,
    true,
    false
...
if ($mManager->isModuleInstalled($moduleId)) {
    ...
    \Bitrix\Main\Config\Option::set($moduleId, 'register_phone_required', 1);
    ...
    \Bitrix\Main\Config\Option::set($moduleId, 'apiEnabled', 0);
    \Bitrix\Main\Config\Option::set($moduleId, 'apiOnlyHttps', 0);
    \Bitrix\Main\Config\Option::set($moduleId, 'registration_fee', 0);
    \Bitrix\Main\Config\Option::set($moduleId, 'contacts_open', 0);
    \Bitrix\Main\Config\Option::set($moduleId, 'startBalance', 100);
    \Bitrix\Main\Config\Option::set($moduleId, 'response_checklists', 0);
    \Bitrix\Main\Config\Option::set($moduleId, 'safeCrowServer', 'dev');
    \Bitrix\Main\Config\Option::set($moduleId, 'courierIblocks', \Bitrix\Main\Web\Json::encode([]));
...
try {
    $types = [
        ...
        'DSPI_VERIFY_EXECUTOR' => array
        (
            'FROM' => '#DEFAULT_EMAIL_FROM#',
            'TO' => '#DEFAULT_EMAIL_FROM#'
        ),
        'DSPI_UNREAD_MESSAGES' => array
        (
            'FROM' => '#DEFAULT_EMAIL_FROM#',
            'TO' => '#EMAIL#'
        ),
