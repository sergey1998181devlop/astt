...
$arNewUrlRewrite = array(
    array(
        "CONDITION" => "#^" . WIZARD_SITE_DIR . "api/v1/([a-z-]+)/($|\?.+$)$#",
    ...
    array(
        'CONDITION' => "#^" . WIZARD_SITE_DIR . "city-([a-z-]+)/([a-z-]+)/([\\da-z-]+)/([\\da-z-]+)-([\\d]+)/($|\\?.+$)$#",
    ...
    array(
        "CONDITION" => "#^" . WIZARD_SITE_DIR . "city-([a-z-]+)/([a-z-]+)/([\da-z-]+)/($|\?.+$)$#",
    ...
    array(
        "CONDITION" => "#^" . WIZARD_SITE_DIR . "city-([a-z-]+)/([a-z-]+)/($|\?.+$)$#",
