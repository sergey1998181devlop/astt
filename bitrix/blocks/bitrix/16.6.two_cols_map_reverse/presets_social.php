...
$result = [
	...
	'vk' => [
		'name' => '<i class="landing-block-card-social-icon fa fa-vk"></i> '.Loc::getMessage('LANDING_BLOCK_16_6_TWO_COLS_MAP--PRESET_VK'),
	...
	'odnoklassniki' => [
		'name' => '<i class="landing-block-card-social-icon fa fa-odnoklassniki"></i> '.Loc::getMessage('LANDING_BLOCK_16_6_TWO_COLS_MAP--PRESET_OK'),
