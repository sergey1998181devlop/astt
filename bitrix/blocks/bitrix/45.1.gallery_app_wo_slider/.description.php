...
return array(
	'block' => array(
		'name' => Loc::getMessage('LANDING_BLOCK_45.1.GALLERY_APP_WO_SLIDER_NAME_NEW'),
		'section' => array('image'),
		'dynamic' => false,
	),
	'cards' => array(
	...
	'nodes' => array(
		...
		'.landing-block-node-card-subtitle' => array(
			'name' => Loc::getMessage('LANDING_BLOCK_45.1.GALLERY_APP_WO_SLIDER_NODES_LANDINGBLOCKNODECARDSUBTITLE'),
			'type' => 'text',
		),
	),
	'style' => array(
		'.landing-block-node-card-title-container' => array(
			'name' => Loc::getMessage('LANDING_BLOCK_45.1.GALLERY_APP_WO_SLIDER_NODES_LANDINGBLOCKNODECARDTITLE_CONTAINER'),
			'type' => array('bg'),
		),
		'.landing-block-node-card-title' => array(
			'name' => Loc::getMessage('LANDING_BLOCK_45.1.GALLERY_APP_WO_SLIDER_NODES_LANDINGBLOCKNODECARDTITLE'),
