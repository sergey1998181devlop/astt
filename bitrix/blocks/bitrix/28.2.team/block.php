	...
	<div class="landing-block-node-bgimg u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_7--after g-pt-30 g-pt-80--md g-pb-250"
		...
		<div class="container text-center u-bg-overlay__inner g-max-width-800">
			<div class="landing-block-node-header text-uppercase g-brd-primary g-mb-30 u-heading-v2-4--bottom">
				<h3 class="landing-block-node-subtitle landing-semantic-subtitle-medium-primary font-weight-bold g-font-size-12 g-color-primary g-mb-20">Our
					team</h3>
				<h2 class="landing-block-node-title landing-semantic-title-image-medium u-heading-v2__title g-line-height-1 g-letter-spacing-2 font-weight-bold g-font-size-40 g-color-white mb-0">
