...
return [
	'contact-link' => [
		'name' => Loc::getMessage('LANDING_BLOCK_16_4_THREE_COLS_MAP--PRESET_LINK'),
		'html' => '<div class="landing-block-card-address g-mb-20" data-card-preset="contact-link">
							...
							<a class="landing-block-card-address-link d-inline-block g-color-white text-uppercase g-font-size-14 font-weight-bold" href="mailto:info@company24.com">
								info@company24.com
							</a>
						</div>',
		'values' => [
	...
	'contact-text' => [
		'name' => Loc::getMessage('LANDING_BLOCK_16_4_THREE_COLS_MAP--PRESET_TEXT'),
