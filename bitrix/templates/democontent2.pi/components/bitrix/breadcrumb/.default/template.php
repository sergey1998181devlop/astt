...
foreach ($arResult as $k => $v) {
    ...
    if ($i == $c) {
        ...
        if(!empty($v['LINK'])){
            ...
            $strReturn .= '<li><span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span itemprop="name">' . $v['TITLE'] . '</span><meta itemprop="position" content="' . $i . '" /></span></span></li>';
        }
    }
    endif;
