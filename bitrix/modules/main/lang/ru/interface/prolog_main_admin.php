...
$MESS["TRIAL_ATTENTION_TEXT1_ua_bitrix_portal"] = "Это пробная версия продукта \"Битрикс: Корпоративный портал\".";
...
$MESS["TRIAL_ATTENTION_TEXT4_ua_bitrix_portal"] = "Срок работы пробной версии продукта \"Битрикс: Корпоративный портал\" истек. Через две недели этот сайт заблокируется, разблокировать его будет невозможно";
...
$MESS["TRIAL_ATTENTION_TEXT5_ua_bitrix_portal"] = "Вы можете купить полнофункциональную версию продукта по адресу <a href=\"https://www.bitrix.ua/buy/intranet.php\">https://www.bitrix.ua/</a>";
...
$MESS["prolog_main_support11_l"] = "<span class=\"required\">Внимание!</span> Срок действия стандартной лицензии <b>заканчивается</b> #FINISH_DATE#, #DAYS_AGO#.#WHAT_IS_IT#<br />Вы можете приобрести продление стандартной лицензии для получения доступа к обновлениям и технической поддержке.";
$MESS["prolog_main_support21_l"] = "<span class=\"required\">Внимание!</span> Срок действия стандартной лицензии <b>закончился</b> #FINISH_DATE#, <b>#DAYS_AGO#&nbsp;дней</b> назад.#WHAT_IS_IT#<br />ВВы можете приобрести продление стандартной лицензии для получения доступа к обновлениям и технической поддержке.";
$MESS["prolog_main_support31_l"] = "<span class=\"required\">Внимание!</span> Срок действия стандартной лицензии <b>закончился</b> #FINISH_DATE#.#WHAT_IS_IT#<br />Вы можете приобрести продление стандартной лицензии для получения доступа к обновлениям и технической поддержке.";


$MESS["prolog_main_support_wit_descr2_l"] = "Окончание срока действия стандартной лицензии приводит к наложению ограничений на систему обновлений, на некоторые функциональные возможности продукта и техническую поддержку.<br /><br />
 После окончания срока действия стандартной лицензии вы не сможете устанавливать обновления платформы, получать новые версии продукта и устанавливать дополнения из каталога решений Маркетплейс, а так же продления для них. Одновременно с этим прекращается работа наших облачных сервисов, например «CDN» или «Облачный бекап».<br /><br />
Так же, для вас становится не доступной техническая поддержка.<br /><br />
Для того чтобы продолжить пользоваться вышеперечисленными возможностями, необходимо приобрести продление.<br /><br />
Обращаем ваше внимание, что вы можете продолжать использование продукта на условиях ограниченной лицензии без ограничения по времени.<br /><br />
С подробностями можно ознакомится в «<a href=\"http://www.1c-bitrix.ru/download/law/eula_bus.pdf\" target=\"_blank\">Лицензионном соглашении</a>»
";
$MESS["prolog_main_support_wit_descr2_l_cp"] = "Окончание срока действия стандартной лицензии приводит к наложению ограничений на систему обновлений, на некоторые функциональные возможности продукта и техническую поддержку.<br /><br />
После окончания срока действия стандартной лицензии вы не сможете устанавливать обновления платформы, получать новые версии продукта и устанавливать дополнения из каталога решений Маркетплейс, а так же продления для них.<br />
Одновременно с этим прекращается работа нашего сервиса «Облачный бекап»<br /><br />
Так же, для вас становится не доступной техническая поддержка. <br /><br />
Для того чтобы продолжить пользоваться вышеперечисленными возможностями, необходимо приобрести продление.<br /><br />
Обращаем ваше внимание, что вы можете продолжать использование продукта на условиях ограниченной лицензии без ограничения по времени.<br /><br />
С подробностями можно ознакомится в «<a href=\"http://www.1c-bitrix.ru/download/law/eula_cp.pdf\" target=\"_blank\">Лицензионном соглашении</a>»";
