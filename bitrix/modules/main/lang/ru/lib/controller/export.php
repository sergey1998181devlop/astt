...
$MESS["MAIN_EXPORT_FILE_DROPPED"] = "Файл экспорта удалён";
$MESS["MAIN_EXPORT_VOID"] = "Отсутствуют данные для экспорта";
$MESS["MAIN_EXPORT_PURGE"] = "Временные файлы, оставшиеся после предыдущего экспорта удалены.";
$MESS["MAIN_EXPORT_EXPECTED_DURATION"] = "Осталось примерно: ";
$MESS["MAIN_EXPORT_EXPECTED_DURATION_HOURS"] = "#HOURS# ч. #MINUTES# мин.";
$MESS["MAIN_EXPORT_EXPECTED_DURATION_MINUTES"] = "#MINUTES# мин.";
?>