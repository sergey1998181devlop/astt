...
return [
	'contact-link' => [
		'name' => '<span class="icon icon-envelope"></span> '.Loc::getMessage("LANDING_BLOCK_35.5.HEADER_PRESET__LINK"),
		'html' => '
	...
	'contact-text' => [
		'name' => '<span class="icon icon-clock"></span> '.Loc::getMessage("LANDING_BLOCK_35.5.HEADER_PRESET__TEXT"),
		'html' => '
			<div class="landing-block-node-card col-md g-mb-10 g-mb-0--md g-brd-right--md g-brd-gray-light-v4"
