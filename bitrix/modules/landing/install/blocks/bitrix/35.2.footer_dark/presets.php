...
return [
	'text' => [
		...
		'html' => '<div class="landing-block-card-contact g-pos-rel g-pl-20 g-mb-7" data-card-preset="text">
						...
						<div class="landing-block-node-card-contact-text g-color-gray-light-v1">Address: In sed lectus tincidunt</div>
					</div>',
		'values' => [
	...
	'link' => [
		...
		'html' => '<div class="landing-block-card-contact g-pos-rel g-pl-20 g-mb-7" data-card-preset="link">
						...
						<div>
							...
							<a class="landing-block-node-card-contact-link g-color-gray-light-v1 font-weight-bold" href="mailto:info@company24.com" target="_blank">info@company24.com</a>
						</div>
					</div>',
		'values' => [
			'.landing-block-node-card-contact-icon' => [
