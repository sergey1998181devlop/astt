...
return [
	'link' => [
		'name' => '<span class="icon-call-in"></span> '.Loc::getMessage("LANDING_BLOCK_FORM_33_1--PRESET_LINK"),
		'html' => '
		...
		'values' => [
			'.landing-block-card-linkcontact-link' => [
				'href' => 'tel:32(0)333444555',
				'text' => '+32 (0) 333 444 555'
			],
	...
	'text' => [
		'name' => '<span class="icon-anchor"></span> '.Loc::getMessage("LANDING_BLOCK_FORM_33_1--PRESET_TEXT"),
		'html' => '
