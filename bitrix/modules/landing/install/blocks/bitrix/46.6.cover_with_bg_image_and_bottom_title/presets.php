		...
		'html' =>
			...
			<div class="u-bg-overlay__inner w-100">
				<div class="g-max-width-645 py-0 g-px-30 g-pb-30" data-stop-propagation>
					<h2 class="landing-block-node-card-title landing-semantic-title-image-medium js-animation fadeInUp g-line-height-1 font-weight-bold g-font-size-90 g-color-white g-mb-15">
						Company24 agency</h2>
					<div class="landing-block-node-card-text-container js-animation fadeInUp row align-items-start">
						...
						<div class="col-md-3 col-lg-3">
							<a href="#"
							   class="landing-block-node-card-button landing-semantic-link-image-medium text-uppercase btn u-btn-outline-white btn-md rounded-0">
								Read more
							</a>
						</div>
					</div>
			...
			'<div class="landing-block-node-card js-slide d-flex align-items-end u-bg-overlay g-height-100vh g-bg-img-hero g-bg-black-opacity-0_5--after bg-video__wrapper" data-card-preset="video">
				...
				<div class="u-bg-overlay__inner w-100">
					<div class="g-max-width-645 py-0 g-px-30 g-pb-30">
						<h2 class="landing-block-node-card-title js-animation fadeInUp g-line-height-1 font-weight-bold g-font-size-90 g-color-white g-mb-15">
							Company24 video</h2>
						<div class="landing-block-node-card-text-container js-animation fadeInUp row align-items-start">
