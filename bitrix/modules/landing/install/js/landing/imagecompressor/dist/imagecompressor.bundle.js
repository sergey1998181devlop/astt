...
(function (exports,main_core) {
	...
	function () {
	  ...
	  babelHelpers.createClass(Compressor, [{
	    key: "init",
	    value: function init() {
	      var _this = this;
	...
	var allowedSizeProps = ['width', 'height', 'maxWidth', 'maxHeight', 'minWidth', 'minHeight'];
	    ...
	    try {
	      ...
	      xhr.onload = function () {
	        if (xhr.status === 200) {
	          ...
	          reject(new Error("Loading error: ".concat(xhr.statusText)));
	        }
	      };
	...
	function () {
	  function ImageCompressor(file) {
	    ...
	    if (this.options.retina) {
	      allowedSizeProps.forEach(function (prop) {
	        if (main_core.Type.isNumber(_this.options[prop])) {
	          _this.options[prop] *= 2;
	        }
	      });
	    }
	  }

	  babelHelpers.createClass(ImageCompressor, [{
	    key: "compress",
