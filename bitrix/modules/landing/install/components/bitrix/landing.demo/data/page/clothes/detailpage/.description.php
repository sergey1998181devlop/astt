...
return array(
	'code' => 'clothes/detailpage',
	'name' => Loc::getMessage('LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--NAME'),
	'description' => NULL,
	'type' => 'store',
	'version' => 2,
	'fields' => array(
		...
		'ADDITIONAL_FIELDS' => array(
			'METAOG_IMAGE' => 'https://cdn.bitrix24.site/bitrix/images/demo/page/clothes/detailpage/preview.jpg',
			'VIEW_USE' => 'N',
			'VIEW_TYPE' => 'no',
			'THEME_CODE' => 'travel',
		),
		...
		1 => array(
			...
			'nodes' => array(
				'.landing-block-node-subtitle' => array(
					0 => Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_1"),
				),
				'.landing-block-node-title' => array(
					0 => Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_2"),
				),
				'.landing-block-node-text' => array(
					0 => Loc::getMessage("NOTTRANSLATE--LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_1"),
				),
			),
			'style' => array(
				'.landing-block-node-title' => array(
		...
		3 => array(
			...
			'nodes' => array(
				'.landing-block-node-subtitle1' => array(
					0 => '<span style="font-weight: normal;">'. Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_3").'</span>',
				),
				'.landing-block-node-title1' => array(
					0 => '<span style="font-weight: bold;">'. Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_4").'</span>',
				),
				'.landing-block-node-button1' => array(
					0 => array(
						'text' => Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_5"),
				...
				'.landing-block-node-img1' => array(
					0 => array(
						'alt' => '',
						'src' => 'https://cdn.bitrix24.site/bitrix/images/landing/business/eshop/640x690/img1.jpg',
					),
				),
				'.landing-block-node-subtitle2' => array(
					0 => '<span style="font-weight: normal;">'. Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_6").'</span>',
				),
				'.landing-block-node-title2' => array(
					0 => '<span style="font-weight: bold;">'. Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_7").'</span>',
				),
				'.landing-block-node-text2' => array(
					0 => Loc::getMessage('NOTTRANSLATE--LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_2'),
				),
				'.landing-block-node-img2' => array(
					0 => array(
						'alt' => '',
						'src' => 'https://cdn.bitrix24.site/bitrix/images/landing/business/eshop/640x690/img2.jpg',
					),
				),
				'.landing-block-node-title-mini' => array(
					0 => Loc::getMessage("NOTTRANSLATE--LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_3"),
					1 => '
								1+1=1',
				),
				'.landing-block-node-text-mini' => array(
					0 => Loc::getMessage("NOTTRANSLATE--LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_4"),
					1 => Loc::getMessage("NOTTRANSLATE--LANDING_DEMO_STORE_CLOTHES-DETAILPAGE--TEXT_5"),
				),
