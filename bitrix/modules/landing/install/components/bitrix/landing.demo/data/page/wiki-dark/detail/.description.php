...
return [
	...
	'fields' => [
		...
		'ADDITIONAL_FIELDS' => [
			...
			'METAOG_IMAGE' => 'https://cdn.bitrix24.site/bitrix/images/demo/page/wiki-dark/detail/preview.jpg',
			'BACKGROUND_USE' => 'N',
	...
	'items' => [
		...
		'#block15123' => [
			...
			'style' => [
				'.landing-block-node-text' => [
					0 => 'landing-block-node-text g-pb-1 container g-max-width-container text-left g-color-gray-light-v3 g-pr-150',
				],
				'#wrapper' => [
					0 => 'landing-block js-animation g-pt-auto g-pb-auto animation-none animated g-bg-transparent',
				],
			],
		],
		'#block15124' => [
			...
			'style' => [
				...
				'#wrapper' => [
					0 => 'landing-block g-pb-10 g-pl-5 g-pr-5 g-pt-50 g-pb-10 g-bg-transparent',
				],
			],
		],
		'#block15133' => [
			...
			'style' => [
				...
				'#wrapper' => [
					0 => 'landing-block g-bg-transparent g-pt-10 g-pb-10',
				],
			],
		],
		'#block15125' => [
		...
		'#block15126' => [
			...
			'style' => [
				...
				'#wrapper' => [
					0 => 'landing-block g-pt-20 g-pb-20 g-bg-transparent',
				],
			],
		],
		'#block15127' => [
			...
			'style' => [
				...
				'#wrapper' => [
					0 => 'landing-block g-pt-30 g-pb-50 g-bg-transparent',
				],
			],
		],
		'#block15131' => [
			...
			'style' => [
				...
				'#wrapper' => [
					0 => 'landing-block g-pt-30 g-pb-30 g-pl-15 g-pr-15 g-bg-transparent',
				],
			],
		],
		'#block15128' => [
		...
		'#block15129' => [
			...
			'style' => [
				'.landing-block-node-text' => [
					0 => 'landing-block-node-text g-pb-1 container text-left g-max-width-container g-color-gray-light-v1 g-pr-150',
				],
				'#wrapper' => [
					0 => 'landing-block js-animation g-pt-auto g-pb-auto animation-none animated g-bg-transparent',
				],
		...
		'#block15132' => [
			...
			'style' => [
				...
				'.landing-block-text' => [
					...
					1 => 'col-10 offset-2 col-md-11 offset-md-1 text-left landing-block-text g-color-gray-light-v1',
					2 => 'col-10 offset-2 col-md-11 offset-md-1 text-left landing-block-text g-color-gray-light-v1',
