<?php
$MESS['LANDING_TABLE_FIELD_BLOCK_CODE'] = 'Символьный код блока';
$MESS['LANDING_TABLE_FIELD_BLOCK_PARAMS'] = 'Параметры вызова';
$MESS['LANDING_TABLE_FIELD_LAST_BLOCK_ID'] = 'Идентификатор последнего блока';
