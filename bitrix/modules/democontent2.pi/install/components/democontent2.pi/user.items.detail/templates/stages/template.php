                ...
                <div class="col-sm-12 col-md-9 col-lg-8 col-xxs-12">
                    <div class="white-block adding-job">
                        ...
                        <form method="post" enctype="multipart/form-data"
                            ...
                            <div id="stages" class="stages form-group" style="display: block;">
                                <div class="stages-list">
                                    <?php
                                    $i = 0;
                                    foreach ($arResult['ITEM']['STAGES'] as $STAGE) {
                                        $i++;
                                        ?>
                                        <div class="itm existing" data-id="<?= $STAGE['ID'] ?>">
                                            <div class="ttl bold">
                                                <?= Loc::getMessage('EDIT_COMPONENT_STAGE_STEP_TTL') ?>
                                                # <?= $i ?>
                                                <? if (count($arResult['ITEM']['STAGES']) !== 1): ?>
                                                    <a href="#" class="remove">
                                            ...
                                            <div class="form-group">
                                                <label for="stage-name<?= $STAGE['ID'] ?>">
                                                    <?= Loc::getMessage('EDIT_COMPONENT_STAGE_LBL_TTL') ?>
                                                </label>
                                                <input required id="stage-name<?= $STAGE['ID'] ?>"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-xxs-12">
                                                    <div class="form-group">
                                                        <label for="stage-price<?= $STAGE['ID'] ?>">
                                                            <?= Loc::getMessage('EDIT_COMPONENT_LBL_BUDGET') ?>
                                                        </label>
                                                        <input id="stage-price<?= $STAGE['ID'] ?>"
                                                               class="budget-inp  form-control number-float" type="text"
                                                               name="stages[<?= $STAGE['ID'] ?>][price]" <?= (!$STAGE['UF_PRICE']) ? 'disabled' : '' ?>
                                                               value="<?= ($STAGE['UF_PRICE']) ? $STAGE['UF_PRICE'] : '' ?>">
                                                    </div>
                                                </div>
                                                <? if (!$arResult['ITEM']['UF_SAFE']): ?>
                                                    <div class="col-sm-6 col-xxs-12">
                                                        <div class="form-group">
                                                            <input <?= (!$STAGE['UF_PRICE']) ? 'checked' : '' ?>
                                                                    class="contract-inp checkbox" type="checkbox"
                                                                    name="stages[<?= $STAGE['ID'] ?>][contractPrice]"
                                                                    value="0"
                                                                    id="stage-contract<?= $STAGE['ID'] ?>"/>
                                                            <label class="form-checkbox"
                                                                   for="stage-contract<?= $STAGE['ID'] ?>">
                                ...
                                <div class="btn-wrap text-right">
                                    <a href="#" class="btn btn-sm btn-orange">
                                        <?= Loc::getMessage('EDIT_COMPONENT_STAGE_ADD_BTN') ?>
                                    </a>
                                </div>
                            </div>
                            <div class="form-group">
