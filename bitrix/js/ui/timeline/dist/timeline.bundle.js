	...
	function (_History) {
	  ...
	  babelHelpers.createClass(Comment, [{
	    ...
	    value: function renderExpandButton() {
	      this.layout.expandButton = main_core.Tag.render(_templateObject5$3(), this.onExpandButtonClick.bind(this), main_core.Loc.getMessage(this.isCollapsed ? 'UI_TIMELINE_EXPAND' : 'UI_TIMELINE_COLLAPSE'));
	    ...
	    value: function onExpandButtonClick(event) {
	      ...
	      if (this.isCollapsed === true) {
	        ...
	        this.getExpandButton().innerText = main_core.Loc.getMessage('UI_TIMELINE_COLLAPSE');
	        ...
	        this.getExpandButton().innerText = main_core.Loc.getMessage('UI_TIMELINE_EXPAND');
