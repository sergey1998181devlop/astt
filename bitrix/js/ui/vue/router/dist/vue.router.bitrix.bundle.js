(function (exports,ui_vue) {
  ...
  function resolveProps(route, config) {
    switch (babelHelpers.typeof(config)) {
      ...
      default:
        {
          warn(false, "props in \"" + route.path + "\" is a " + babelHelpers.typeof(config) + ", " + "expecting an object, function or boolean.");
        }
    }
  }
  /*  */
  ...
  var vendorVueRouter = VueRouter;
  var bitrixVueRouter = BitrixVueRouter;

  exports.VueRouter = bitrixVueRouter;
  exports.VueRouterVendor = vendorVueRouter;

}((this.BX = this.BX || {}),BX));
//# sourceMappingURL=vue.router.bitrix.bundle.js.map
