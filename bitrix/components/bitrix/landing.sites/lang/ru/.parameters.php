...
$MESS['LANDING_CMP_PAR_TILE_MODE'] = 'Режим открытия по клику на плитку сайта';
$MESS['LANDING_CMP_PAR_TILE_MODE_LIST'] = 'Просмотр страниц сайта';
$MESS['LANDING_CMP_PAR_TILE_MODE_VIEW'] = 'Просмотр сайта';
