...
return array(
	'code' => 'clothes/header_main',
	'name' => Loc::getMessage('LANDING_DEMO_STORE_CLOTHES-HEADERMAIN--NAME'),
	'description' => NULL,
	'type' => 'store',
	'version' => 2,
	'fields' => array(
		...
		0 => array(
			...
			'nodes' => array(
				...
				'.landing-block-node-card-title' => [
					0 => Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-HEADERMAIN--TEXT_1"),
					1 => Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-HEADERMAIN--TEXT_2"),
				],
				...
				'.landing-block-node-card-text' => array(
					0 => Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-HEADERMAIN--TEXT_8"),
				),
			),
			'style' => array(
				'#wrapper' => array(
		...
		1 => array(
			...
			'nodes' => array(
				...
				'.landing-block-node-menu-list-item-link' => array(
					3 => array(
						'text' => Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-HEADERMAIN--TEXT_3"),
					...
					4 => array(
						'text' => Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-HEADERMAIN--TEXT_4"),
					...
					5 => array(
						'text' => Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-HEADERMAIN--TEXT_5"),
					...
					6 => array(
						'text' => Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-HEADERMAIN--TEXT_6"),
					...
					7 => array(
						'text' => Loc::getMessage("LANDING_DEMO_STORE_CLOTHES-HEADERMAIN--TEXT_7"),
