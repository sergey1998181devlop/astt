...
return array(
	'code' => 'clothes/news2',
	'name' => Loc::getMessage('LANDING_DEMO_STORE_CLOTHES-NEWS2--NAME'),
	'description' => NULL,
	'type' => 'store',
	'version' => 2,
	'fields' => array(
		...
		'ADDITIONAL_FIELDS' => array(
			'METAOG_IMAGE' => 'https://cdn.bitrix24.site/bitrix/images/demo/page/clothes/news2/preview.jpg',
			'VIEW_USE' => 'N',
			'VIEW_TYPE' => 'no',
			'THEME_CODE' => 'travel',
		),
	...
	'items' => array(
		0 => array(
			...
			'nodes' => array(
				'.landing-block-node-subtitle' => array(
					0 => Loc::getMessage("NOTTRANSLATE--LANDING_DEMO_STORE_CLOTHES-NEWS2--TEXT_1"),
				),
				'.landing-block-node-title' => array(
					0 => Loc::getMessage("NOTTRANSLATE--LANDING_DEMO_STORE_CLOTHES-NEWS2--TEXT_2"),
				),
		...
		1 => array(
			...
			'nodes' => array(
				'.landing-block-node-title' => array(
					0 => Loc::getMessage("NOTTRANSLATE--LANDING_DEMO_STORE_CLOTHES-NEWS2--TEXT_3"),
				),
				'.landing-block-node-text' => array(
					0 => Loc::getMessage("NOTTRANSLATE--LANDING_DEMO_STORE_CLOTHES-NEWS2--TEXT_4"),
				),
				'.landing-block-node-img' => array(
					0 => array(
						'alt' => 'Image description',
						'src' => 'https://cdn.bitrix24.site/bitrix/images/landing/business/eshop/930x580/img4.jpg',
					),
				),
			),
			'style' => array(
				...
				'#wrapper' => array(
					0 => 'landing-block g-pt-10 g-pb-55',
				),
			),
			'attrs' => array(),
		),
