...
<header class="landing-block landing-block-menu u-header u-header--sticky u-header--relative" >
	...
	<div class="container">
		<div class="landing-block-node-bgimg g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_1--after g-px-20 g-py-200" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/1600x1068/img3.jpg\');" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb">
			<div class="text-center g-pos-rel g-z-index-1 landing-block-node-container js-animation zoomIn">
				...
				<h2 class="landing-block-node-title h2 d-inline-block g-brd-around g-brd-2 g-brd-white g-color-white g-font-weight-700 g-font-size-40 text-uppercase g-line-height-1_2 g-letter-spacing-5 g-py-12 g-px-20 g-mb-50">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT4").'</h2>
	...
	<div class="container">
        ...
        <div class="container text-center g-max-width-800">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-color-black g-mb-minus-10 g-font-size-33">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT12").'<br /></h2>
            </div>

			<div class="landing-block-node-text g-color-gray-dark-v5 g-letter-spacing-3"><p>'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT13").'</p></div>
        </div>
		...
		<div class="js-gallery-cards row">
			<div class="landing-block-node-card text-center col-lg-3 col-md-4 col-sm-6 g-mb-30 js-animation slideInUp">
				<div class="g-pos-rel g-parent d-inline-block h-100">
					...
					<div class="landing-block-node-card-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-flex-middle g-bg-primary-opacity-0_9 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
						<h3 class="landing-block-node-card-title h3 g-color-white g-font-size-12">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT14").'</h3>
			...
			<div class="landing-block-node-card text-center col-lg-3 col-md-4 col-sm-6 g-mb-30 js-animation slideInUp">
				<div class="g-pos-rel g-parent d-inline-block h-100">
					...
					<div class="landing-block-node-card-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-flex-middle g-bg-primary-opacity-0_9 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
						<h3 class="landing-block-node-card-title h3 g-color-white g-font-size-12">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT15").'</h3>
						<div class="landing-block-node-card-subtitle g-color-white"> </div>
					</div>
				</div>
			</div>
			...
			<div class="landing-block-node-card text-center col-lg-3 col-md-4 col-sm-6 g-mb-30 js-animation slideInUp">
				<div class="g-pos-rel g-parent d-inline-block h-100">
					...
					<div class="landing-block-node-card-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-flex-middle g-bg-primary-opacity-0_9 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
						<h3 class="landing-block-node-card-title h3 g-color-white g-font-size-12">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT16").'</h3>
						<div class="landing-block-node-card-subtitle g-color-white"> </div>
					</div>
				</div>
			</div>
			...
			<div class="landing-block-node-card text-center col-lg-3 col-md-4 col-sm-6 g-mb-30 js-animation slideInUp">
				<div class="g-pos-rel g-parent d-inline-block h-100">
					...
					<div class="landing-block-node-card-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-flex-middle g-bg-primary-opacity-0_9 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
						<h3 class="landing-block-node-card-title h3 g-color-white g-font-size-12">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT17").'</h3>
						<div class="landing-block-node-card-subtitle g-color-white"> </div>
					</div>
				</div>
			</div>
	...
	<div class="container">
		...
		<div class="row landing-block-inner">
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT20").'</h3>
						<div class="landing-block-node-card-text g-color-gray-dark-v5 mb-0">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT21").'</div>
					</div>
					<!-- End Article Content -->
				</article>
			</div>
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT22").'</h3>
						<div class="landing-block-node-card-text g-color-gray-dark-v5 mb-0">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT23").'</div>
					</div>
					<!-- End Article Content -->
				</article>
			</div>
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT24").'</h3>
						<div class="landing-block-node-card-text g-color-gray-dark-v5 mb-0">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT25").'</div>
					</div>
					<!-- End Article Content -->
				</article>
			</div>
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT27").'</h3>
						<div class="landing-block-node-card-text g-color-gray-dark-v5 mb-0">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT26").'</div>
					</div>
					<!-- End Article Content -->
				</article>
			</div>
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT28").'</h3>
						<div class="landing-block-node-card-text g-color-gray-dark-v5 mb-0">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT29").'</div>
					</div>
					<!-- End Article Content -->
				</article>
			</div>
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT29").'</h3>
						<div class="landing-block-node-card-text g-color-gray-dark-v5 mb-0">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT30").'</div>
					</div>
					<!-- End Article Content -->
				</article>
			</div>
        ...
        <div class="container text-center g-max-width-800">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                <h4 class="landing-block-node-subtitle g-font-weight-700 g-font-size-12 g-color-primary g-mb-15"> </h4>
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-color-black g-mb-minus-10 g-font-size-12">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT31").'</h2>
            </div>

			<div class="landing-block-node-text g-color-gray-dark-v5 g-letter-spacing-3"><p>'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT32").'</p></div>
        </div>
				...
				<div class="h-100 g-pb-15 g-pb-0--sm">
					<div class="landing-block-node-img-container h-100 g-pos-rel g-parent u-block-hover">
						...
						<div class="landing-block-node-img-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-top-0
							...
							g-color-white g-line-height-1_4 g-letter-spacing-5 g-font-size-20">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT33").'</h3>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="h-100 g-pb-15 g-pb-0--sm">
					<div class="landing-block-node-img-container h-100 g-pos-rel g-parent u-block-hover">
						...
						<div class="landing-block-node-img-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-top-0
							...
							<div class="h-100 g-flex-middle g-brd-around g-brd-white-opacity-0_2 text-uppercase">
								<h3 class="landing-block-node-img-title g-flex-middle-item text-center h3
							g-color-white g-line-height-1_4 g-letter-spacing-5 g-font-size-20">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT34").'</h3>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="h-100 g-pb-0">
					<div class="landing-block-node-img-container h-100 g-pos-rel g-parent u-block-hover">
						...
						<div class="landing-block-node-img-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-top-0
							...
							<div class="h-100 g-flex-middle g-brd-around g-brd-white-opacity-0_2 text-uppercase">
								<h3 class="landing-block-node-img-title g-flex-middle-item text-center h3
							g-color-white g-line-height-1_4 g-letter-spacing-5 g-font-size-20">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT35").'</h3>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="landing-block-node-card col-md-6 col-lg-4 g-mb-30 g-mb-0--md">
				...
				<article class="landing-block-node-card-container js-animation text-center text-uppercase g-theme-photography-bg-gray-dark-v2 g-color-white-opacity-0_5 fadeInRight">
					...
					<header class="g-letter-spacing-3 g-pos-rel g-px-40 g-mb-30">
						...
						<h4 class="landing-block-node-card-title h6 g-color-white g-mt-minus-25 g-mb-10">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT44").'</h4>
						<div class="landing-block-node-card-text g-font-size-12 g-color-gray-dark-v4 mb-0"><p>'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT45").'</p></div>
					</header>
			...
			<div class="landing-block-node-card col-md-6 col-lg-4 g-mb-30 g-mb-0--md">
				...
				<article class="landing-block-node-card-container js-animation text-center text-uppercase g-theme-photography-bg-gray-dark-v2 g-color-white-opacity-0_5 fadeInRight">
					...
					<header class="g-letter-spacing-3 g-pos-rel g-px-40 g-mb-30">
						...
						<h4 class="landing-block-node-card-title h6 g-color-white g-mt-minus-25 g-mb-10">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT52").'</h4>
						<div class="landing-block-node-card-text g-font-size-12 g-color-gray-dark-v4 mb-0"><p>'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT53").'</p></div>
					</header>
			...
			<div class="landing-block-node-card col-md-6 col-lg-4 g-mb-30 g-mb-0--md">
				...
				<article class="landing-block-node-card-container js-animation text-center text-uppercase g-theme-photography-bg-gray-dark-v2 g-color-white-opacity-0_5 fadeInRight">
					...
					<header class="g-letter-spacing-3 g-pos-rel g-px-40 g-mb-30">
						...
						<h4 class="landing-block-node-card-title h6 g-color-white g-mt-minus-25 g-mb-10">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT60").'</h4>
						<div class="landing-block-node-card-text g-font-size-12 g-color-gray-dark-v4 mb-0"><p>'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT61").'</p></div>
					</header>
			...
			<div class="col-sm-12 col-md-2 col-lg-2 g-mb-25 g-mb-0--lg">
				...
				<ul class="landing-block-card-list1 list-unstyled g-mb-30">
					<li class="landing-block-card-list1-item g-mb-10">
						<a class="landing-block-node-list-item g-color-gray-dark-v5" href="#" target="_self">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT73").'</a>
					</li>
					<li class="landing-block-card-list1-item g-mb-10">
						<a class="landing-block-node-list-item g-color-gray-dark-v5" href="#" target="_self">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT74").'</a>
					</li>
					<li class="landing-block-card-list1-item g-mb-10">
						<a class="landing-block-node-list-item g-color-gray-dark-v5" href="#" target="_self">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT75").'</a>
					</li>
					<li class="landing-block-card-list1-item g-mb-10">
						<a class="landing-block-node-list-item g-color-gray-dark-v5" href="#" target="_self">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT76").'</a>
					</li>
				</ul>
			</div>
			...
			<div class="col-sm-12 col-md-2 col-lg-2 g-mb-25 g-mb-0--lg">
				...
				<ul class="landing-block-card-list2 list-unstyled g-mb-30">
					<li class="landing-block-card-list2-item g-mb-10">
						<a class="landing-block-node-list-item g-color-gray-dark-v5" href="#" target="_self">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT78").'</a>
					</li>
			...
			<div class="col-sm-12 col-md-2 col-lg-2 g-mb-25 g-mb-0--lg">
				...
				<ul class="list-unstyled g-mb-30">
					<li class="landing-block-card-list3-item g-mb-10">
						<a class="landing-block-node-list-item g-color-gray-dark-v5" href="#" target="_self">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT80").'</a>
					</li>
					<li class="landing-block-card-list3-item g-mb-10">
						<a class="landing-block-node-list-item g-color-gray-dark-v5" href="#" target="_self">'. Loc::getMessage("NOTTRANSLATE__LANDING_DEMO_23FEB1__TEXT81").'</a>
					</li>
