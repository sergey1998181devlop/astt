...
$MESS["REST_CONFIGURATION_IMPORT_ROLLBACK_MODE_DESCRIPTION"] = "To delete an application that is currently in use, you have to select one of available Bitrix24 presets, or select a new application in the Marketplace.";
