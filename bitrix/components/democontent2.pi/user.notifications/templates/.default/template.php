                            ...
                            foreach ($arResult['ITEMS'] as $key => $item) {
                                ...
                                <div class="item">
                                    ...
                                    <? else: ?>
                                        ...
                                        switch ($item['UF_TYPE']) {
                                            case 'CompanyAdd':
                                                echo 'Компания № <a href="/user/moderataion/company/'. $companyId['companyId'].'/?us='. $companyId['userId'].' ">'. $companyId['companyId']. '</a> '.  'добавлена и требует модерации';
                                             break;
                                             case 'CompanyFalseModeration':
                                                echo '<a href="/user/company/"> Компания  </a> отклонена модератором ';
                                             break;
                                             case 'CompanyTrueModeration':
                                                echo '<a href="/user/company/"> Компания  </a> подтверждена модератором ';
                                             break;
...
//                                                echo Loc::getMessage('NOTIFICATION_' . $item['UF_TYPE'], $data);
                                            echo 'Задание № <a href="/user/tasks/detail/'.$data['taskId'].'/">'.$data['taskId']. '</a> '. Loc::getMessage('NOTIFICATION_' . $item['UF_TYPE'], $data);
                                                break;
                                            case 'responseAdd':
