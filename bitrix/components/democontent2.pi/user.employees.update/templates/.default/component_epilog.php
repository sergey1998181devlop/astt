...
if (count($arResult) > 0) {
    ...
    */
    ...
    $param = $APPLICATION->AddChainItem($arResult['IBLOCK_TYPE_NAME'], SITE_DIR . implode('/', $tempPath) . '/');
//    pre($arResult);
//
    $tempPath[] = $arResult['UF_IBLOCK_CODE'];
    $APPLICATION->AddChainItem($arResult['IBLOCK_NAME'], SITE_DIR . implode('/', $tempPath) . '/');
//
