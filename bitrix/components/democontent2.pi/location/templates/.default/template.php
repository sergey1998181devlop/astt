...
?>
    <div class="location-block ">
        <a class="head" href="#popup-location" data-fancybox>
            ...
            <img src="<?= SITE_TEMPLATE_PATH ?>/images/location.png#compass" class="icon icon_compass icon_compass_newHeader">
            <span class="idCityTopPL" data-target-nameCity="<?=$arResult['CURRENT_CITY_NAME']?>" data-target-idCity="<?=$arResult["CURRENT_CITY_ID"]?>">Ваш город:</span>&nbsp;
            <?php
