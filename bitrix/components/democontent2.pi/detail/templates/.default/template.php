...
$userTaskId = $arResult['UF_USER_ID'];
$rsUserForIdTask = CUser::GetByID($userTaskId);
$arResult['USER'] = $rsUserForIdTask->Fetch();
$arResult['CURRENT_USER'] = $rsUserForIdTask->Fetch();
//pre($arUserForIDTask);
//$arResult['USER'];
?>
<script>
...
<div class="page-content page-content-detail-item">
    <div class="image-bg-detail-item">
        <img src="<?=SITE_TEMPLATE_PATH?>/images/users_518.png">
    </div>
    <div class="image-bg-detail-item2">
        <img src="<?=SITE_TEMPLATE_PATH?>/images/users_519.png">
    </div>
    <div class="wrapper">
        <div class="row task-container " id="sticky-container">
                            ...
                            <div class="tbc">
                                ...
                                <div class="user-info">
                                    ...
                                    <? if (count($arResult['USER']['UF_DSPI_CITY'])): ?>
                                        <div class="location-box d-none" style="display: none">
                                    ...
                                    <?if(!empty($arUserForID['PERSONAL_PHONE']) ):?>
                                        <?if(!empty($arResult['USER']['ID'])):?>
                                           <br> <div class="company-phone-detail">
                                               ...
                                               <div class="phone-non" style="display:none;">
                                                ...
                                                <?if(!empty($arResult['USER']['NAME'])):?>
                                                    <b class="meneder-autP">Менеджер:</b><p><?=$arResult['USER']['NAME']?>&nbsp;<?=$arResult['USER']['LAST_NAME']?></p>
                                                <?endif;?>
                                            </div>
                                        <?endif;?>
                                <?else:?>
                                ...
                                <?endif;?>
                                    ...
                                    <div class="date-box date-box-user-box-right">

                                        <div class="celander">
                                            <img src="<?=SITE_TEMPLATE_PATH?>/images/celender-detail-u.png">
                                        </div>
                                        
                                        <b>Зарегестрирован на сайте</b>:<br>
            ...
            <div class="col-sm-12 col-md-9 col-lg-8 col-xxs-12">
                ...
                <div class="white-block">
                    ...
                    <?if($USER->IsAuthorized()):?>
                    <div class="complain">
                        <div class="complain-item" data-id="<?= $arResult['UF_ID'] ?>" data-path="<?=$this->GetFolder().'/ajaxFavorites.php'?>"
                             data-category="<?= $arResult['UF_IBLOCK_ID'] ?>">

                            <span class="span-star twe start-first <?if(empty($arResult['status_executor'])):?>active<?endif;?>" <?if(empty($arResult['status_executor'])):?> style="display: block;" <?else:?>style="display: none;" <?endif;?> ">
...
<path style="fill:rgba(100,60,37,0.39);" d="M492.757,190.241l-160.969-14.929L267.847,26.833c-4.477-10.396-19.218-10.396-23.694,0
	...
	l121.452-106.694C508.583,205.305,504.029,191.286,492.757,190.241z"/></svg>
                            ...
                            <span class="span-star twe-te <?if(!empty($arResult['status_executor'])):?>active<?endif;?>" <?if(!empty($arResult['status_executor'])):?> style="display: block;" <?else:?>style="display: none;" <?endif;?>>
<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
	...
	L116.085,362.057z"/>                            </span>
                    ...
                    <?else:?>
                        <a href="#popup-registration" data-fancybox="">
                            <div class="complain">
                                <div class="complain-item-not-auth" data-id="<?= $arResult['UF_ID'] ?>" data-path="<?=$this->GetFolder().'/ajaxFavorites.php'?>"
                                     data-category="<?= $arResult['UF_IBLOCK_ID'] ?>">
                    ...
                    <div class="top-panel">
                        <div class="tbl">
                            <div class="tbc col-md-8 col-sm-12 ">
                                <div class="h2 title">
                                    <? if ($arResult['UF_SAFE']): ?>
                                    ...
                                    <?if(!empty($arResult['c']['UF_COUNT_TECH'])):?>
                                        <h1><?= $arResult['UF_NAME'] ?> <?=$arResult['c']['UF_COUNT_TECH']?> шт</h1>
                                    <?else:?>
                            ...
                            <div class="tbc tbc2-container-items col-md-4 col-sm-12 right">
                                <div class="price-box right price-box-custom">
                                    <?if(!empty($arResult['c']['UF_NDS'])):?>
                                        <?if(!empty($arResult['c']['UF_NDS'])):?>
                                            <span class="nds" >C НДС:</span><span class="nds_price"><?=(string)$arResult['c']['UF_NDS']?>₽</span><br>
                                        <?endif;?>
                                    <?endif;?>

                                    <?if(!empty($arResult['c']['UF_BEZNAL']) ):?>
                                        <?if(!empty($arResult['c']['UF_BEZNAL'])):?>
                                            <span class="bezznal" >Без НДС: </span><span class="bezznal_price"><?=(string)$arResult['c']['UF_BEZNAL']?>₽</span><br>
                                        <?endif;?>
                                    <?endif;?>

                                    <?if(!empty($arResult['c']['UF_NALL']) ):?>
                                        <?if(!empty($arResult['c']['UF_NALL'])):?>
                                            <span class="nall" >Нал: </span><span class="nall_price" ><?=(string)$arResult['c']['UF_NALL']?>₽</span><br>
                                        <?endif;?>
                                    <?endif;?>
                    ...
                    <div class="task-indicators task-indicators-task-detail">
                        <?/*<div class="itm">
                            <?
...
*/?>
                        <div class="itm">
                            <div class="date-box date-box-custom">
                                <?if(!empty($dateStartString) && $dateStartString !== ''):?>
                                   <div class="icon_time_block">
                        ...
                        <? if (!empty($arResult['CITY'])): ?>
                            <div class="itm">
                                <div class="location-box location-box-custom">
                                    <svg class="icon icon_location">
                                        <use xlink:href="<?= SITE_TEMPLATE_PATH ?>/images/sprite-svg.svg#location"></use>
                                    </svg>
                                    <?= $arResult['CITY']['name'] ?>
...
*/?>
                    ...
                    <? if (!empty($arResult['UF_BEGIN_WITH'])): ?>
                        <p class="task-indicators-task-detail-p">
                        <span class="ttl bold">
                            Начало работ:
                        </span><br>
                    ...
                    <? if (!empty($arResult['UF_RUN_UP'])): ?>
                        <p class="task-indicators-task-detail-p task-indicators-task-detail-p-end" >
                            <span class="ttl bold">Завершение работ:</span><br>
                            <?= date('d.m.Y H:i', strtotime($arResult['UF_RUN_UP'])) ?>
                        </p><br>
                    <? endif ?>
                    <? if ($stagesL > 0): ?>
                        <div class="ttl bold bold-new-DZ">
                    ...
                    <?if(!empty($arResult['c']['UF_START_ADDRESS_STREET'])){?>
                        <p class="bold-new-DZ"><b>Адрес: </b><?=$arResult['c']['UF_START_ADDRESS_STREET']?></p>
                    <?}?>
                    <?php
                    if (count($route)) {
                        ?>
                    ...
                    switch ($arResult['UF_STATUS']) {
                        ...
                        case 4:
                            if ($USER->IsAuthorized() && isset($arResult['CURRENT_USER']['UF_DSPI_EXECUTOR'])
                                ...
                                if (!$USER->IsAuthorized()) {
                                    ?>
                                    <div class="btn-wrap hidden-sm hidden-xxs hidden-xs d-none">
                                        <a class="btn btn-green" data-fancybox=""
                                    ...
                                    ?>
                                        <?
                                            ...
                                            $rsUserId = CUser::GetByID($idCurUser);
                                            $arUserIdMess = $rsUserId->Fetch();

                                        ?>
                                        <?if(empty($arUserIdMess['PERSONAL_PHONE'])):?>
                ...
                <div class="horizont-baner-newDz">
                    <img src="<?=SITE_TEMPLATE_PATH?>/images/bg-baner-horizont.png">
                </div>
            </div>
        </div>
    </div>
