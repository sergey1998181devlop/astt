...
class UserSettings extends CBitrixComponent
{
    public function executeComponent()
    {
        ...
        if ($USER->IsAuthorized()) {
            ...
            if ($request->isPost()) {
                ...
                if ($request->getPost('type')) {
                    ...
                    if ($request->getPost('addCard')) {
                        ...
                        if ($request->getPost('changePass')) {
                            $result = $us->changePassFunc();

                            LocalRedirect('/user/settings/?changePass='.$result['keyInfo']);
                            $this->arResult['changePass'] = $result;
                        ...
                        if ($request->getPost('update_personal_dataNameLastN')) {

                            $us->updateUserPers($_POST, $_FILES);
            ...
            $APPLICATION->AddChainItem('Настройки' , '/user/settings/');
