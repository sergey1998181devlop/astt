                        ...
                        <div class="tabs-wrap">
                            <div class="tab active" id="tab-profile1">
                                <form action="<?= $APPLICATION->GetCurPage(false) ?>" method="post"
                                    ...
                                    <div class="company-number-i">
                                        <div class="h4">Номер компании:</div>
                                        <p>&nbsp<?=$arResult['COMPANY'][0]['UF_HOT_NAMBER_COMPANY']?></p>
                                    </div>
                                    <?endif;?>
...
<?//debmes($arResult['USER']);?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-xxs-12">
                                            ...
                                            <br>
                                            <select id="my-city" name="city"  class="js-select required " style="width: 100%">
                                                <option></option>
                                                <?php foreach ($arResult['CITIES'] as $key => $item) {?>
                                                        <?
                                                            $selected = '';
                                                            if(!empty($arResult['USER']['UF_DSPI_CITY']) && $arResult['USER']['UF_DSPI_CITY'] == $item['id']){
                                                                $selected = "selected";
                                                            }
                                                        ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <input type="hidden" name="OldNumber" value="<?= \Democontent2\Pi\Utils::formatPhone($arResult['USER']['PERSONAL_PHONE']) ?>">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?if(empty($arResult['USER']['PERSONAL_PHONE'])):?>
                                                                        <div class=" btn btn-green left  pers_data update__account_data phoneBtnApprove" style="display: none" data-type-check="phone">
                                                                            Подтвердить номер
                                                                        </div>
                                                                    <?else:?>
                                                                        <div class=" btn btn-green left  pers_data update__account_data phoneBtnApprove" style="display: none" data-type-check="phone" >
                                                        ...
                                                        <?else:?>
                                                            ...
                                                            <?if( $arResult['USER']['UF_CONFIRMED'] == "false"):?>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <input type="hidden" name="NumberAdmin" value="<?=$arResult['COMPANY'][0]['UF_ADMIN_COMPANY_ID']?>">
                                                                        <input type="hidden" name="UserNameEmpl" value="<?=$arResult['USER']['NAME']?>">
                                                                        <input type="hidden" name="UserFemaleEmpl" value="<?=$arResult['USER']['LAST_NAME']?>">


                                                                         <?if(!empty($arResult['USER']['PERSONAL_PHONE'])):?>
                                                                             <div class=" btn btn-green left  pers_data update__account_data emplBtnApprovePhone phoneBtnApprove" style="display: none" data-type-check="phone">
                                                                                 <?= Loc::getMessage('USER_SETTINGS_UPDATE_US__PHONE') ?>
                                                                             </div>
                                                                         <?else:?>
                                                                             <div class=" btn btn-green left  pers_data update__account_data emplBtnApprovePhone phoneBtnApprove" style="display: none" data-type-check="phone">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <input type="hidden" name="EmailOld" value="<?= $arResult['USER']['EMAIL'] ?>">
                                                            <input class="form-control emailUpAc-mail required" type="text" name="authEmail"
                                                        ...
                                                        <div class="col-sm-6" style="display: none">
                                                            <div class="form-group">
                                                                ...
                                                                <div class=" btn btn-green left  pers_data update__account_data" data-type-check="mail">
                                                        ...
                                                        <?if($arResult['USER']['UF_MODERATION_ACCESS'] == "true" || $arResult['USER']['UF_MODERATION_ACCESS'] == "false"):?>
                                                            <div class="col-sm-6" >
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class=" btn btn-green left  pers_data update__account_data emailCheck"  style="display: none" data-type-check="mail" >
                                                                        Обновить email
                                                                    </div>
                                ...
                                <?if( $arResult['USER']['UF_MODERATION_ACCESS'] == "true" || $arResult['USER']['UF_MODERATION_ACCESS'] == "false"):?>
                                    <div class="row">
                                        ...
                                        <?//tсли нету номера телефона имя и мыла / то кнопка сохранить заблочена и разблочется когда имя будет телефон будет и мыло ?>
                                        <?if(!empty($arResult['USER']['NAME']) && !empty($arResult['USER']['PERSONAL_PHONE']) && !empty($arResult['USER']['EMAIL']) ):?>
                                            <button class="btn-submit btn btn-green left  pers_data pers_dataBtnSaveData" type="submit">
                                                <?= Loc::getMessage('USER_SETTINGS_COMPONENT_BTN_SUBMIT') ?>
                                            </button>
                                        <?else:?>
                                            <button class="btn-submit btn btn-green left  pers_data pers_dataBtnSaveData" disabled type="submit">
                                                <?= Loc::getMessage('USER_SETTINGS_COMPONENT_BTN_SUBMIT') ?>
                                            </button>
                                        <?endif;?>
                                    </div>
