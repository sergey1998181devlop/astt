                    ...
                    <div class="white-block adding-job">
                        <form method="post" enctype="multipart/form-data" action="<?= $APPLICATION->GetCurPage() ?>">
                            <div class="form-group changeNameBl">
                                ...
                                <div id="create-inp1" class="form-control required titleNewOrder" type="text">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xxs-12">
                                    <div class="form-group">
                                        ...
                                        <select id="create-inp-category" required class="js-select" style="width: 100%">
                                            <option  class="notInp notInpCategory"  targCode="" value="">&nbsp;</option>
                                            <?php
                                ...
                                <div class="col-sm-12 col-xxs-12">
                                    <div class="form-group">
                                        ...
                                        <select id="create-inp-subcategory" required disabled="disabled" class="js-select" name="iblock"
                                                style="width: 100%">
                                            <option targCode=""  class="notInp notInpSubCategory" value="">&nbsp;</option>
                                            <?php
                            ...
                            <div class="row" id="total-budget">
                                ...
                                <div class="moneyBlock">
                                    ...
                                    <div class="col-sm-12 col-xxs-12">
                                        <div class="col-sm-6 col-xxs-12">
                                            <div class="form-group">
                                                <label for="create-inp3">
                                                    <?= Loc::getMessage('CREATE_COMPONENT_LBL_BUDGET_BEZ_NDS') ?>
                                                </label>
                                                <input required id="create-inp3" class="form-control required" type="text"
                                                       name="contractPrice" placeholder="<?= Loc::getMessage('CREATE_COMPONENT_LBL_BUDGET_BEZ_NDS') ?>"
                                                       value="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea required id="create-inp-desc"  minlength="15" name="description" class="form-control required"
