...
<div class="page-content">
    <div class="wrapper">
        <div class="row task-container  task-container-detail-moderation" id="sticky-container">
                            ...
                            <div class="tbc col-md-8 col-sm-12 ">
                                <div class="h2 title">
                                    ...
                                    <?if(!empty($arResult['UF_COUNT_TECH'])):?>
                                        <h1> <?= $arResult['UF_NAME'] ?> <?=$arResult['UF_COUNT_TECH']?> шт</h1>
                                    <?else:?>
...
*/?>
                    ...
                    <?if(!empty($arResult['c']['UF_START_ADDRESS_STREET'])){?>
                        <p class="bold-new-DZ"><b>Адрес: </b><?=$arResult['UF_START_ADDRESS_STREET']?></p>
                    <?}?>
                    <?php
                    if (count($route)) {
                        ?>
                    ...
                    <?if(  $arResult['UF_MODERATION'] == 0 || $arResult['UF_MODERATION'] == 5 || $arResult['UF_MODERATION'] == 2
                    ):?>
                        <div class="row">
                            <div class="col-sm-6 col-md-6 col-xxs-12">
                                <?if( $arResult['UF_MODERATION'] == 5 || $arResult['UF_MODERATION'] == 2){?>
                                    <!--                                опубликовать  если статус 5 или 2 когда отклонили -->
                                    <form action="<?= $APPLICATION->GetCurPage(false) ?> "
                                          method="post">
                                        <input type="hidden" name="ID_EL_HL" value="<?=$arResult['ID']?>">
                                        <input type="hidden" name="IBLOCK_ID_EL_HL" value="<?=$arResult['UF_IBLOCK_ID']?>">
                                        <input type="hidden" name="UF_ITEM_ID" value="<?=$arResult['UF_ITEM_ID']?>">
                                        <input type="hidden" name="publicUserSet" value="Ypublic">
                                        <button type="submit" class="remove-from-the-public">
                                           Опубликовать
                                        </button>
                                    </form>
                                <?}else{?>
                                    ...
                                    <form action="<?= $APPLICATION->GetCurPage(false) ?> "
                                        ...
                                        <input type="hidden" name="IBLOCK_ID_EL_HL" value="<?=$arResult['UF_IBLOCK_ID']?>">
                                        <input type="hidden" name="UF_ITEM_ID" value="<?=$arResult['UF_ITEM_ID']?>">
                                        <input type="hidden" name="remove-from-the-public" value="Yremove">
                                        <button type="submit" class="remove-from-the-public">
                                            Снять с публикации
                                        </button>
                                    </form>
                                ...
                                <?if( $arResult['UF_MODERATION'] == 5){?>
                                    <div class="block-employe">
                                        <form action="<?= $APPLICATION->GetCurPage(false) ?> "
                                            ...
                                            <input type="hidden" name="IBLOCK_ID_EL_HL" value="<?=$arResult['UF_IBLOCK_ID']?>">
                                            <input type="hidden" name="UF_ITEM_ID" value="<?=$arResult['UF_ITEM_ID']?>">
                                            <input type="hidden" name="remove-task-end" value="YremoveTaskEnd">
                                            <button type="submit" class="remove-from-the-public">
                                                Удалить
                                            </button>
                                        </form>
