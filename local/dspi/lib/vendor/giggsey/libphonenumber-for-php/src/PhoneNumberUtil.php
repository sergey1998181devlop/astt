...
class PhoneNumberUtil
{
    ...
    protected static function createExtnPattern($singleExtnSymbols)
    {
        ...
        return (static::RFC3966_EXTN_PREFIX . static::$CAPTURING_EXTN_DIGITS . '|' . "[ \xC2\xA0\\t,]*" .
            ...
            '‰Ó·|' . '[' . $singleExtnSymbols . "]|int|\xEF\xBD\x89\xEF\xBD\x8E\xEF\xBD\x94|anexo)" .
     ...
     * as well as any text before the number (e.g. a leading ìTel: î) and trims the non-number bits.
    ...
    public function isPossibleNumberForTypeWithReason(PhoneNumber $number, $type)
    {
        ...
        // da Cu?ha), but this is handled by putting all possible lengths for any country with this
